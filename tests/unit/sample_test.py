...
from physician_conversion_mlops.tasks.sample_etl_task import SampleETLTask
from physician_conversion_mlops.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/physician_conversion_mlops/sample_experiment"
    }
